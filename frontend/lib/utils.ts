...
/**
 * Deterministically maps any string (e.g. speaker name) to a fixed accessible color theme palette.
 */
export function getSpeakerColor(name: string): { bg: string; text: string; border: string; dot: string } {
  const palette = [
    ...
    { bg: "bg-amber-50 dark:bg-amber-950/40", text: "text-amber-700 dark:text-amber-300", border: "border-amber-200 dark:border-amber-800", dot: "bg-amber-500" },
    ...
    { bg: "bg-sky-50 dark:bg-sky-950/40", text: "text-sky-700 dark:text-sky-300", border: "border-sky-200 dark:border-sky-800", dot: "bg-sky-500" },
...
/**
 * Relative date formatter utility (e.g. "2 days ago", "Yesterday")
 */
